...
const GenerateImages = () => {
    ...
    const imageStyle = ['Realistic', 'Ghibli style', 'Anime Style', 'Cartoon style', 'Fantasy style', 'Realistic style', '3D style', 'Pixel art style', 'Cyberpunk style', 'Steampunk style']
  ...
  return (
    <div className='h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700'>
     {/* left col */}
     <form onSubmit={onSubmitHandler} className='w-full max-w-2xl p-4 bg-white rounded-lg border border-gray-200'>
